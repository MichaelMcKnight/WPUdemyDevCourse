...
registerBlockType( 'udemy/recipe', {
    ...
    description:        __( 'Provides a short summary of a recipe' ),
        ...
        return [
            <InspectorControls>
                <PanelBody title={ __( 'Basics', 'recipe' ) }>
                    ...
                    <SelectControl
                        ...
                        help={ __( 'Ex: breakfast, lunch, dinner', 'recipe' ) }
            ...
            <div className={ props.className }>
                ...
                <ul class="list-unstyled" style={{ textAlign: props.attributes.text_alignment }}>
                    ...
                    <li><strong>{ __( 'Utensils', 'recipe' ) }: </strong> <span className="utensils-ph"></span>{ props.attributes.utensils }</li>
